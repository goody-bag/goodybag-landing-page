...
export default function Hero() {
  ...
  const heroImages = ["/hero-celebration.jpg", "/hero-family.jpg"];
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-accent-pink via-white to-purple-50">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute bottom-20 right-10 w-96 h-96 bg-accent-purple/30 rounded-full blur-3xl animate-float"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-8 animate-slide-up">
            ...
            <h2
              className="text-3xl md:text-5xl font-bold text-secondary leading-tight animate-slide-up"
              style={{ animationDelay: "0.1s" }}
            >
              Gifting is{" "}
              <span className="text-primary animate-pulse">Love</span>
            </h2>

            <p
              className="text-lg md:text-xl text-gray-dark max-w-xl animate-slide-up"
              style={{ animationDelay: "0.2s" }}
            >
              From surprise boxes to corporate gifting, GoodyBag lets you
              curate, customize, and deliver gifts effortlessly. Join the
            ...
            {/* Trust indicators */}
            <div
              className="flex flex-wrap gap-6 justify-center lg:justify-start pt-8 animate-slide-up"
