...
export default function HowItWorks() {
  ...
  const steps = [
    {
      ...
      description:
        "Browse our curated selection of gifts from trusted vendors. Filter by occasion, recipient, or budget to find the perfect items.",
      icon: "🛍️",
        ...
        <div className="relative w-full h-full">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-pink-100 via-rose-100 to-red-100 rounded-3xl p-8 flex flex-col items-center justify-center overflow-hidden">
            ...
            <div className="absolute top-4 left-4 w-20 h-20 bg-white rounded-xl shadow-lg transform rotate-12 animate-float">
              <div className="w-full h-full bg-gradient-to-br from-pink-300 to-rose-400 rounded-xl flex items-center justify-center text-3xl">
                🎁
              </div>
            </div>
            <div
              className="absolute top-8 right-8 w-16 h-16 bg-white rounded-xl shadow-lg transform -rotate-12 animate-float"
              style={{ animationDelay: "0.5s" }}
            >
              <div className="w-full h-full bg-gradient-to-br from-rose-300 to-pink-400 rounded-xl flex items-center justify-center text-2xl">
                🎀
              </div>
            </div>
            <div
              className="absolute bottom-6 left-8 w-18 h-18 bg-white rounded-xl shadow-lg transform rotate-6 animate-float"
              style={{ animationDelay: "1s" }}
            >
              <div className="w-full h-full bg-gradient-to-br from-red-300 to-rose-400 rounded-xl flex items-center justify-center text-2xl">
                🎊
              </div>
            </div>
            ...
            <div
              className="absolute top-1/2 left-4 w-8 h-8 border-4 border-rose-300 rounded-full animate-rotate-slow"
    ...
    },
    {
      ...
      description:
        "Add personal touches with custom messages, choose your packaging style, and select from beautiful wrapping options.",
      icon: "✨",
      ...
      visual: (
        <div className="relative w-full h-full">
          <div className="absolute inset-0 bg-gradient-to-br from-blue-100 via-cyan-100 to-teal-100 rounded-3xl p-8 flex flex-col items-center justify-center overflow-hidden">
            {/* Sparkle effects */}
            <div className="absolute top-6 left-6 text-4xl animate-pulse">
              ✨
            </div>
            <div
              className="absolute top-12 right-8 text-3xl animate-pulse"
              style={{ animationDelay: "0.3s" }}
            >
              ⭐
            </div>
            <div
              className="absolute bottom-8 left-10 text-3xl animate-pulse"
              style={{ animationDelay: "0.6s" }}
            >
              💫
            </div>
            <div
              className="absolute bottom-12 right-6 text-4xl animate-pulse"
            ...
            <div
              className="absolute top-1/3 left-6 w-10 h-10 border-4 border-cyan-300 rounded-full animate-rotate-slow"
              style={{ animationDirection: "reverse" }}
            ></div>
          </div>
        </div>
    ...
    },
    {
      ...
      description:
        "Enter delivery details for one or multiple recipients. Track your gifts in real-time and get notified when they arrive.",
      icon: "🚀",
      ...
      visual: (
        <div className="relative w-full h-full">
          <div className="absolute inset-0 bg-gradient-to-br from-green-100 via-emerald-100 to-teal-100 rounded-3xl p-8 flex flex-col items-center justify-center overflow-hidden">
            ...
            <div
              className="absolute bottom-8 right-8 w-16 h-16 bg-white rounded-full shadow-lg flex items-center justify-center animate-pulse"
              style={{ animationDelay: "0.5s" }}
            >
              <span className="text-2xl">📍</span>
            </div>
            ...
            <div className="absolute top-1/2 left-1/4 right-1/4 h-1 bg-gradient-to-r from-green-400 via-emerald-400 to-green-400 rounded-full transform -translate-y-1/2">
              ...
              <div
                className="absolute right-0 top-0 w-4 h-4 bg-green-500 rounded-full -translate-y-1.5 animate-pulse"
                style={{ animationDelay: "0.3s" }}
              ></div>
            </div>
            ...
            <div
              className="absolute bottom-1/4 left-6 w-8 h-8 border-4 border-emerald-300 rounded-full animate-rotate-slow"
              style={{ animationDirection: "reverse" }}
            ></div>
          </div>
        </div>
  ...
  return (
    <section
      id="how-it-works"
      className="py-24 bg-gradient-to-b from-white via-pink-50/30 to-blue-50/30 relative overflow-hidden"
    >
      {/* Background decorative elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 left-10 w-96 h-96 bg-primary/5 rounded-full blur-3xl animate-float"></div>
        <div
          className="absolute bottom-20 right-10 w-96 h-96 bg-purple-300/10 rounded-full blur-3xl animate-float"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/2 w-80 h-80 bg-blue-300/10 rounded-full blur-3xl animate-float"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20 animate-slide-up">
          ...
          <p className="text-xl md:text-2xl text-gray-dark font-medium">
            Sending the perfect gift is as easy as{" "}
            <span className="text-primary font-bold">1-2-3</span>
          </p>
        </div>
            ...
            >
              ...
              <div className="flex-1 w-full">
                <div className="relative h-[400px] md:h-[500px]">
                  ...
                  <div
                    className={`absolute -top-6 -left-6 w-20 h-20 bg-gradient-to-br ${step.gradient} text-white rounded-2xl flex items-center justify-center text-3xl font-bold shadow-2xl transform rotate-12 hover:rotate-0 transition-transform duration-300 z-20 animate-pulse-glow`}
                  >
                    {step.number}
                  </div>
                </div>
              ...
              <div className="flex-1 w-full">
                <div className="space-y-6 animate-slide-up">
                  <div className="flex items-center gap-4">
                    <div
                      className={`${step.iconBg} w-20 h-20 rounded-2xl flex items-center justify-center shadow-xl transform hover:scale-110 transition-transform duration-300`}
                    >
                      <span className="text-5xl">{step.icon}</span>
                    </div>
                    <div>
                      <div
                        className={`text-transparent bg-gradient-to-r ${step.gradient} bg-clip-text font-bold text-sm uppercase tracking-wider mb-2`}
                      >
                        Step {step.number}
                      </div>
                  ...
                  <div className="flex items-center gap-2 text-primary font-semibold">
                    ...
                    <span className="text-2xl transform hover:translate-x-2 transition-transform">
                      →
                    </span>
                  </div>
                </div>
        ...
        <div className="text-center mt-24 animate-scale-in">
          <div className="bg-gradient-to-r from-pink-100 via-purple-100 to-blue-100 rounded-3xl p-12 md:p-16 shadow-2xl border-4 border-white/50 relative overflow-hidden">
            ...
            <div className="absolute inset-0 opacity-20">
              <div className="absolute top-4 left-4 text-6xl animate-float">
                🎁
              </div>
              <div
                className="absolute bottom-4 right-4 text-6xl animate-float"
                style={{ animationDelay: "1s" }}
              >
                🎀
              </div>
              <div
                className="absolute top-1/2 left-1/2 text-5xl animate-float"
                style={{ animationDelay: "2s" }}
              >
                ✨
              </div>
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl md:text-2xl text-gray-dark mb-10 font-medium">
                Join our waitlist to be among the first to experience GoodyBag
                when we launch
              </p>
              <button
                onClick={() =>
